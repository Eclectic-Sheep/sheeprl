...
class ChatUI:
    ...
    def load_model(self, experiment_dir: str, checkpoint_path: str):
        ...
        try:
            ...
            self.model = CasualModel.from_checkpoint(device="cuda", model_cfg=self.model_cfg, path=model_path)
    ...
    def load_example(self):
        ...
        data_processor: DataProcessor = hydra.utils.instantiate(self.data_cfg)
        ...
        if os.path.exists(full_path):
            ...
            return (
                gr.update(
                    visible=True,
                    value="""<h3 style="color:red;text-align:center;word-break: break-all;">Dataset from training experiment is not available</h3>""",
                ),
                None,
            )
