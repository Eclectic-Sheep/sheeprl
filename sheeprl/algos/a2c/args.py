...
class A2CArgs(StandardArgs):
    ...
    per_rank_batch_size: int = Arg(default=128, help="the batch size for each rank")
    ...
    gae_lambda: float = Arg(default=1.0, help="the lambda for the general advantage estimation")
