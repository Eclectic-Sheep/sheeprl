...
namespace tree {
    ...
    class CNode {
        public:
            int visit_count, action_num, hidden_state_index_x, hidden_state_index_y, best_action;
            ...
            void expand(int hidden_state_index_x, int hidden_state_index_y, float reward, const std::vector<float> &policy_logits);
    ...
    class CRoots{
        public:
            ...
            void prepare(float root_exploration_fraction, const std::vector<std::vector<float>> &noises, const std::vector<float> &rewards, const std::vector<std::vector<float>> &policies);
