...
class DreamerV2Args(StandardArgs):
    ...
    learning_starts: int = Arg(default=int(1e4), help="timestep to start learning")
    ...
    kl_free_nats: float = Arg(default=0.0, help="the minimum value for the kl divergence")
