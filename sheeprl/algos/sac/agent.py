...
class SACCritic(nn.Module):
    def __init__(self, observation_dim: int, hidden_sizes: int = 256, num_critics: int = 1):
...
class SACActor(nn.Module):
    def __init__(
        ...
        """
        super().__init__()
        self.model = MLP(input_dims=observation_dim, hidden_sizes=(hidden_sizes, hidden_sizes), flatten_dim=None)
